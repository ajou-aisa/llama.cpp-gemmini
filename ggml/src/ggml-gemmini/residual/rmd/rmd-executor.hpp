...
private:
  friend RmdStatus
  merge_rmd_correction_with_weights(const ggml_gemmini_args_t &, float *,
                                    const StripePacket &, const Correction &,
                                    RmdWeightPreparation &, size_t *);
  RmdStatus prepare_columns(const ggml_gemmini_args_t &args,
