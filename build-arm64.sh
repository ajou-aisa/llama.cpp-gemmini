...
GGML_GEMMINI_OPTION_DEFAULT=${GGML_GEMMINI_OPTION:-CPU} # CPU | WS
...
GGML_GEMMINI_COMPUTE_TYPE_DEFAULT=${GGML_GEMMINI_COMPUTE_TYPE_DEFAULT:-${GGML_GEMMINI_COMPUTE_TYPE:-FLOAT}} # INT | FLOAT
...
GGML_GEMMINI_ACTIVATION_BITS_DEFAULT=${GGML_GEMMINI_ACTIVATION_BITS_DEFAULT:-${GGML_GEMMINI_ACTIVATION_BITS:-4}} # 4 | 8 | 16
GGML_GEMMINI_WEIGHT_BITS_DEFAULT=${GGML_GEMMINI_WEIGHT_BITS_DEFAULT:-${GGML_GEMMINI_WEIGHT_BITS:-4}} # 4 | 8 | 16
