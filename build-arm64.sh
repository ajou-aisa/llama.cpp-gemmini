...
# Build the selected Gemmini backend on ARM64 (Linux or macOS); FPGA_UART outputs live in build-arm64/bin by default.
...
IM2P_FPGA_DEFAULT_DEVICE_DEFAULT=${IM2P_FPGA_DEFAULT_DEVICE:-uart4:/dev/serial/by-id/usb-Digilent_Digilent_USB_Device_210319BE7725-if01-port0}
